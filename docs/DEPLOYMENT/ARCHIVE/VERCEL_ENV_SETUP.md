...
- [ ] You have gathered all credentials (see `PRODUCTION_ENV_SETUP.md`)
...
1. Check `PRODUCTION_ENV_SETUP.md` for credential gathering
2. Check `ENV_SETUP_CHECKLIST.md` for tracking progress
