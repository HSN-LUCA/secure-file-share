              ...
              <motion.div className="w-full mb-4 sm:mb-6"
                ...
                <div className="flex justify-center">
                  <MagneticButton onClick={handleUpload} disabled={uploading}
                    className="px-5 py-2.5 text-white font-semibold text-sm rounded-full hover:shadow-xl transition-shadow disabled:opacity-50 flex items-center justify-center gap-2"
                    style={{ background: 'linear-gradient(to right, #F5C842, #D4A017)', boxShadow: '0 4px 20px rgba(212,160,23,0.35)' }}>
                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center flex-shrink-0">
                      <Upload className="w-3 h-3" style={{ color: '#D4A017' }} />
                    </div>
                    <span className="uppercase tracking-wider text-xs sm:text-sm">{uploading ? t.uploading : t.upload}</span>
                  </MagneticButton>
                </div>
